...
* После, в этой же вкладке <b>Домены</b> добавляем новый домен и указываем путь к папке <b>имя папки проекта/src</b>, имя домена, на свой вкус или так же, как имя папки проекта, сохраняем, запускаем!
